...
def bark():
  ...
  Requirements: 
    1. The proper nouns (name and breed) must be capitalized in the output, as is standard in English writing, 
  ...
  # print('Spot, the 4 year old Schnauzer, says, "Woof!"')
...
def bark_with_validation():
  ...
  if not age.isdigit() or not (0 <= int(age) <= 15):
    print("Age error!")
    return
  breed = input("please enter the breed of the dog: ").capitalize()
